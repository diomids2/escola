...
<html lang="pt-br">
    ...
    <head>
        ...
        <meta name="author" content="Claudiomir Neves">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseTree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="index.php?pag=<?php echo $menu9 ?>">Mensalidades</a>

                            <a class="collapse-item" href="index.php?pag=<?php echo $menu10 ?>">Contas à Pagar</a>
